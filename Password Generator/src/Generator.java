    ...
    public void mainLoop() throws IOException {
        ...
        while (!UsersChoice.equals("4")) {
            ...
            switch (UsersChoice) {
                ...
                case "4" -> {
                    passwordDB database = new passwordDB("databaseContainer.txt");
                    Scanner sc=new Scanner(System.in);
                    System.out.println("Select an operation");
                    System.out.println("-------------------");
                    System.out.println("1 - Adding a string to Database");
                    System.out.println("2 - Deleting a string from Database");
                    System.out.println("3 - View all contents of the database");
                    System.out.println();
                    ...
                    if(choice==1){
                        System.out.println();
                        System.out.println("Please enter the string to add into the database");
                        String s=sc.nextLine();
                        database.addString(s);
                        System.out.println();
                    }else if(choice==2){
                        System.out.println();
                        System.out.println("Please enter the string to delete into the database");
                        String s=sc.nextLine();
                        database.deleteString(s);
                        System.out.println();
                    }else if(choice==3){
                        System.out.println();
                        System.out.println("Database Contents");
                        System.out.println("--------------------");
                        database.viewAllContent();
                        System.out.println();
                    }
                }
